...
public class RanksEditLevelOtherCommand extends CommandBase {
    ...
    public RanksEditLevelOtherCommand(KingdomCraftImpl kdc) {
        ...
        setExplanationMessage(() -> kdc.getMessages().getMessage("cmdRanksEditLevelOtherExplanation"));
    ...
    public void execute(PlatformSender sender, String[] args) {
        ...
        if ( !args[2].matches("[0-9]+") ) {
            kdc.getMessages().send(sender, "errorInvalidNumber", args[2]);
            return;
        }
        ...
        kdc.getMessages().send(sender, "cmdRanksEditOther", "level",
