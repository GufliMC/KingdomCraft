...
public class ChatChannelLeaveCommand extends CommandBase {

    public ChatChannelLeaveCommand(KingdomCraftImpl kdc) {
        super(kdc, "chatchannel leave", 1, true);
        addCommand("channel leave");
        setExplanationMessage(() -> kdc.getMessages().getMessage("cmdChatChannelLeaveExplanation"));
        setPermissions("kingdom.chatchannel.leave");
    }
