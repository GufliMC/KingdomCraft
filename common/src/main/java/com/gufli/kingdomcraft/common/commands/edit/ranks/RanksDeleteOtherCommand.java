...
public class RanksDeleteOtherCommand extends CommandBase {
    ...
    public RanksDeleteOtherCommand(KingdomCraftImpl kdc) {
        ...
        setExplanationMessage(() -> kdc.getMessages().getMessage("cmdRanksDeleteOtherExplanation"));
    ...
    public void execute(PlatformSender sender, String[] args) {
        ...
        if ( kingdom.getDefaultRank().equals(rank) ) {
            kdc.getMessages().send(sender, "cmdRanksDeleteOtherDefault", kingdom.getName());
        } else {
            kdc.getMessages().send(sender, "cmdRanksDeleteOther", rank.getName(), kingdom.getName());
        }
