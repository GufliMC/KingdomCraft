...
import com.igufguf.kingdomcraft.common.database.DatabaseManager;
import com.igufguf.kingdomcraft.common.handlers.CommandHandler;
import com.igufguf.kingdomcraft.common.managers.DefaultKingdomManager;
import com.igufguf.kingdomcraft.common.handlers.MessageHandler;
...
public class KingdomCraft extends JavaPlugin implements KingdomCraftPlugin {
	...
	public DefaultKingdomManager kingdomHandler;
	public DefaultPlayerManager playerHandler;
	...
	public void onEnable() {
		...
		kingdomHandler = new DefaultKingdomManager(this, databaseManager.getDatabase());
		playerHandler = new DefaultPlayerManager(this, databaseManager.getDatabase());
